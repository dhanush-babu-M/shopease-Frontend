...
import HeroCarousel from "../components/HeroCarousel"; // 1. Import new component
...
const Home = () => {
  // Example filters
  const deals = allProducts.filter((p) => p.id % 3 === 0).slice(0, 8);
  const topElectronics = allProducts.filter(
    (p) => p.category === "Mobiles" || p.category === "Laptops"
  );
        ...
        <section className="bg-surface rounded-xl p-8 shadow-card">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <Feature
              ...
              description="Your payments are safe and secure with our encryption."
            />
            <Feature
